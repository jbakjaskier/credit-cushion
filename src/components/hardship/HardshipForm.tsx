...
export default function HardshipForm() {
  ...
  return state.mode === "success" ? (<div className="mt-4 w-full max-w-2xl">

    <CheckCircleIcon width={50} height={50} stroke="green"/>
    <h1 className="text-2xl text-gray-900">Thank you</h1>
    <p className="text-sm text-gray-900">Thanks for telling us about your hardship. We're evaluating it and will be with you shortly. Please have an eye on your email</p>
  </div>) : (<form className="mt-4 w-full max-w-2xl" action={formAction}>
      ...
      <div className="border-b border-gray-900/10 pb-12">
        ...
        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div className="sm:col-span-4">
            ...
            {state.mode === "error" && state.errorDetails.fullLegalName !== undefined && <p className="text-sm mt-2 font-medium text-red-500">{state.errorDetails.fullLegalName}</p>}
          </div>
          ...
          <div className="sm:col-span-4">
            ...
            {state.mode === "error" && state.errorDetails.emailAddress !== undefined && <p className="text-sm mt-2 font-medium text-red-500">{state.errorDetails.emailAddress}</p>}
          </div>
          ...
          <div className="sm:col-span-4">
            ...
            {state.mode === "error" && state.errorDetails.phoneNumber !== undefined && <p className="text-sm mt-2 font-medium text-red-500">{state.errorDetails.phoneNumber}</p>}
          ...
          <div className="sm:col-span-3">
            ...
            {state.mode === "error" && state.errorDetails.circumstanceReason !== undefined && <p className="text-sm mt-2 font-medium text-red-500">{state.errorDetails.circumstanceReason}</p>}
          </div>
          ...
          <div className="col-span-full">
            ...
            {state.mode === "error" && state.errorDetails.circumstanceExplanation !== undefined && <p className="text-sm mt-2 font-medium text-red-500">{state.errorDetails.circumstanceExplanation}</p>}
          </div>
          ...
          <div className="col-span-full">
            ...
            {state.mode === "error" && state.errorDetails.idealArrangement !== undefined && <p className="text-sm mt-2 font-medium text-red-500">{state.errorDetails.idealArrangement}</p>}
          </div>
          ...
          <div className="col-span-full">
            ...
            {state.mode === "error" && state.errorDetails.supportingDocument !== undefined && <p className="text-sm mt-2 font-medium text-red-500">{state.errorDetails.supportingDocument}</p>}
    ...
    <div className="mt-6 flex items-center justify-end gap-x-6">
      {isPending ? <ProgressLoader /> : <button
        type="submit"
