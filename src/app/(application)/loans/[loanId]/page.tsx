...
export default async function LoanDetailsPage({
  ...
  const loanInDb: Loan | DbFetcherError = ObjectId.isValid(params.loanId)
    ? await getLoanFromDbAsync(new ObjectId(params.loanId))
    : {
        ...
        <div className="mt-8">
          <div className="px-4 sm:px-0">
            ...
            <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">
              {`Information that we've collected based on the documents that you've sent to the customer`}
            </p>
          </div>
          <div className="mt-6">
