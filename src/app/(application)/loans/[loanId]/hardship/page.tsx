    ...
    <div>
      ...
      {isDbFetcherError(loanInDb) ? (
        ...
        <div className="mt-8">
            ...
            {loanInDb.hardship.envelopeDetails === undefined ? (
              ...
              <dl className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
                  ...
                  <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">
                    {loanInDb.hardship.envelopeDetails.envelopeStatus.charAt(0).toUpperCase() + loanInDb.hardship.envelopeDetails.envelopeStatus.slice(1)}
                  </dd>
                </div>
                <div className="border-t border-gray-100 px-4 py-6 sm:col-span-1 sm:px-0">
                  <dt className="text-sm font-medium leading-6 text-gray-900">
                  ...
                  <dd className="mt-1 text-sm leading-6 text-gray-700 sm:mt-2">
                    {readerFriendlyDateString(loanInDb.hardship.envelopeDetails.lastUpdated)}
                  </dd>
                </div>
          ...
          {loanInDb.hardship.loanVariationStatus === "variationGenerated" && loanInDb.hardship.variatedContractContent !== undefined && <div className="px-4 sm:px-0">
            <h3 className="text-base font-semibold leading-7 text-gray-900">
          ...
          {
            loanInDb.hardship.loanVariationStatus === "variationGenerated" && loanInDb.hardship.variatedContractContent !== undefined && <div className="mt-6"> 
                <VariationOfContractEditor loanId={loanId} generatedContent={loanInDb.hardship.variatedContractContent} />
            </div>
          }
        </div>
      )}
